...
- Place google-services.json in driver/android/app/
- Place GoogleService-Info.plist in driver/ios/Runner/ if building for iOS
...
For Android:
`ash
flutter build apk --release --dart-define=APP_ROLE=driver --dart-define=API_BASE_URL=https://your-api.example.com/api
`
