...
class Order {
  ...
  Order copyWithRealtime({
    ...
    return Order(
      ...
      restaurantCommissionType: restaurantCommissionType,
      restaurantCommissionValue: restaurantCommissionValue,
      ...
      onlinePaymentVerifiedAt: onlinePaymentVerifiedAt,
      ...
      readyByAt: readyByAt ?? this.readyByAt,
      readyCountdownSeconds:
          readyCountdownSeconds ?? this.readyCountdownSeconds,
      isPreparationDelayed: isPreparationDelayed,
      preparationDelayMinutes: preparationDelayMinutes,
      remainingPreparationMinutes: remainingPreparationMinutes,
      ...
      driverAssignmentAttempts: driverAssignmentAttempts,
