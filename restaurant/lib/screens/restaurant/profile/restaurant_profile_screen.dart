      ...
      body: ListView(
        ...
        children: [
          ...
          _ProfileMenuItem(
            ...
            onTap: () => Navigator.pushNamed(context, '/restaurant/profile/edit'),
          ),
          _ProfileMenuItem(
            icon: Icons.account_balance_outlined,
            title: 'Bank Details',
            subtitle: 'Payout account and settlement preferences',
            onTap: () => Navigator.pushNamed(context, '/restaurant/profile/bank'),
          ),
          _ProfileMenuItem(
          ...
          _ProfileMenuItem(
            ...
            onTap: () => Navigator.pushNamed(context, '/restaurant/profile/help'),
          ),
          _ProfileMenuItem(
            icon: Icons.gavel_outlined,
            title: 'Legal',
            subtitle: 'Policies, terms and partnership documents',
            onTap: () => Navigator.pushNamed(context, '/restaurant/profile/legal'),
          ),
        ],
      ),
    );
