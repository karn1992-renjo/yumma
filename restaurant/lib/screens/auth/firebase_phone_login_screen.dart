...
class _FirebasePhoneLoginScreenState extends State<FirebasePhoneLoginScreen> {
  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      ...
      if (!authProvider.canUseCurrentApp) {
        ...
        if (!mounted) return;
        _showMessage('Please login with a restaurant account.', isError: true);
        return;
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.appName.isEmpty ? 'Restaurant Login' : widget.appName),
      ),
      body: SafeArea(
              ...
              children: [
                ...
                Text(
                  _otpSent
                      ...
                      : 'Firebase will verify your phone before we log you into the restaurant app.',
