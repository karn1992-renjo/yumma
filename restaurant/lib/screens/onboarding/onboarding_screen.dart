...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingModel> screens = [
    OnboardingModel(
      ...
      description: 'Control orders, menu, and operations all from one easy-to-use dashboard',
      icon: Icons.dashboard,
      color: Color(0xFF667EEA),
    ),
    OnboardingModel(
      title: 'Real-time Orders',
      description: 'Receive, track, and manage orders in real-time with automated notifications',
      icon: Icons.receipt_long,
      color: Color(0xFF764BA2),
    ),
    OnboardingModel(
      title: 'Increase Revenue',
      description: 'Reach more customers, manage promotions, and boost your sales',
      icon: Icons.trending_up,
      color: Color(0xFFD71E64),
    ),
    OnboardingModel(
      title: 'Analytics & Insights',
      description: 'Track performance metrics and make data-driven decisions for your business',
