...
class Restaurant {
  ...
  factory Restaurant.fromJson(Map<String, dynamic> json) {
    ...
    return Restaurant(
      ...
      cuisine: cuisineList,
      logoImage: json['logo_image'] ?? json['image_url'],
      bannerImage: json['banner_image'] ?? json['banner_url'],
      rating: _parseDouble(json['rating'], fallback: 0.0),
      reviewCount: _parseInt(
        json['total_ratings'] ?? json['review_count'],
        fallback: 0,
      ),
  ...
  String get logoUrl => logoImage?.toString().isNotEmpty == true ? '${AppConfig.apiBaseUrl}/storage/$logoImage' : '';
  String get bannerUrl => bannerImage?.toString().isNotEmpty == true ? '${AppConfig.apiBaseUrl}/storage/$bannerImage' : '';
  String get cuisineText => cuisine.join(', ');
  bool get isDining => restaurantType == 'dining' || restaurantType == 'both';
  bool get isDelivery => restaurantType == 'delivery' || restaurantType == 'both';
}
