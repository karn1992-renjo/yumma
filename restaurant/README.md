...
- Place google-services.json in restaurant/android/app/
- Place GoogleService-Info.plist in restaurant/ios/Runner/ if building for iOS
...
`ash
flutter run \\
  --dart-define=APP_ROLE=restaurant \\
...
For Android:
`ash
flutter build apk --release --dart-define=APP_ROLE=restaurant --dart-define=API_BASE_URL=https://your-api.example.com/api
`
