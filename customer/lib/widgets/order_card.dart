              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    if (_amount(order['platform_fee']) > 0)
                      _buildPriceRow(
                        context,
                        'Platform Fee',
                        _amount(order['platform_fee']),
                      ),
                    _buildPriceRow(context, 'Taxes & Charges', order['tax']),
                    if (_amount(order['discount']) > 0)
                      _buildPriceRow(
                        context,
                        'Coupon Discount',
                        -_amount(order['discount']),
                      ),
                    const Divider(),
                    _buildPriceRow(
                      context,
