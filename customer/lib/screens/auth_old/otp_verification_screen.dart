...
class _OtpVerificationScreenState extends State<OtpVerificationScreen>
    with CodeAutoFill {
  static const _green = A1PasoAuthColors.green;
            ...
            return Stack(
              children: [
                SingleChildScrollView(
                  ...
                  padding: const EdgeInsets.fromLTRB(28, 10, 28, 118),
                  child: ConstrainedBox(
                    constraints:
                        BoxConstraints(minHeight: constraints.maxHeight - 128),
                    child: Column(
                      children: [
                        Align(
                        ...
                        Image.asset(
                          ...
                          width: compact ? 236 : 266,
                          height: compact ? 112 : 126,
                          fit: BoxFit.contain,
                        ),
                        SizedBox(height: compact ? 36 : 52),
                        const A1PasoShieldBadge(size: 132),
                        SizedBox(height: compact ? 36 : 52),
                        const Text(
                          'Verify Your Number',
...
class _OtpThreeDButtonState extends State<_OtpThreeDButton> {
  ...
  Widget build(BuildContext context) {
    ...
    const surfaceColor = Color(0xFFBDEBD2);
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: A1PasoAuthColors.green.withOpacity(_enabled ? 0.18 : 0.10),
        ...
        child: DecoratedBox(
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: [Color(0xFFD8F5E5), surfaceColor, Color(0xFFA9E3C4)],
              stops: [0, 0.58, 1],
            ),
          ),
          child: Stack(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: active ? A1PasoAuthColors.green : A1PasoAuthColors.border,
