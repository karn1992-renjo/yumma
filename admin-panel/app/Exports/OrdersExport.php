...
class OrdersExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function headings(): array
    {
        return [
            ...
            'Restaurant Commission Type', 'Restaurant Commission Value', 'Restaurant Earning Commission',
            'GST on Platform Commission', 'Online Payment Gateway Fee', 'Net Restaurant Payout',
            'Driver Delivery Base', 'Driver Commission Type', 'Driver Commission Value', 'Driver Earning Commission', 'Batch Bonus',
