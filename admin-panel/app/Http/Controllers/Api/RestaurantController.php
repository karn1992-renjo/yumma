...
class RestaurantController extends Controller
{
    ...
    private function restaurantPromotionAttributes(Request $request, Restaurant $restaurant, array $validated, ?Promotion $promotion = null): array
    {
        ...
        return [
            ...
            'funding_type' => $validated['funding_type'] ?? 'restaurant',
            'platform_share_percent' => isset($validated['platform_share_percent']) ? (float) $validated['platform_share_percent'] : null,
            'restaurant_share_percent' => isset($validated['restaurant_share_percent']) ? (float) $validated['restaurant_share_percent'] : null,
            'partner_name' => $validated['partner_name'] ?? null,
            'total_budget' => isset($validated['total_budget']) ? (float) $validated['total_budget'] : null,
