    ...
    <div class="container">
        ...
        <div class="rounded-5 p-4 position-relative overflow-hidden" style="background-color: {{ $backgroundColor }};">
            ...
            <div class="position-relative">
                ...
                <div class="row g-4">
                    @foreach(array_slice($section['items'], 0, 2) as $restaurant)
                        @php
                                ...
                                <div>
                                    ...
                                    <div class="pt-3">
                                        <div class="d-flex justify-content-between align-items-start gap-2">
                                            <div class="fw-bold text-dark" style="font-size: 1.35rem; line-height:1.1;">{{ $restaurant['name'] }}</div>
                                        ...
                                        <div class="text-muted fw-semibold mt-2">
                                            {{ $restaurant['delivery_time'] }}-{{ $restaurant['delivery_time'] + 5 }} mins
                                            @if($amountForOne > 0)
