...
<style>
    ...
    .panel-link { color:#6d28d9; text-decoration:none; font-size:12.5px; font-weight:900; white-space:nowrap; }
    .panel-link:hover { color:#5b21b6; }
...
<div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
    <div>
        ...
        <p>Cash collected by drivers on delivery, pending deposit reconciliation.</p>
    </div>
    <a href="{{ route('admin.cod.history') }}" class="btn btn-light border">
...
<div class="cod-kpi-grid">
    <div class="kpi-card" style="--accent:#f59e0b;--card-glow:rgba(245,158,11,.16);">
        ...
        <div class="kpi-sub">Cash held by drivers right now</div>
    </div>
...
<div class="dash-panel">
    ...
    <div class="collect-panel-body">
        ...
        @else
            <form method="POST" action="{{ route('admin.cod.settle') }}" class="collect-grid" id="codCollectForm">
                @csrf
                <div>
...
<div class="dash-panel">
    <div class="cod-filter-bar">
        <form method="GET" action="{{ route('admin.cod.index') }}" class="row g-2 align-items-center">
            <div class="col-md-5">
            ...
            <div class="col-md-1">
                <a href="{{ route('admin.cod.index') }}" class="btn btn-light w-100 border" title="Clear"><i class="fas fa-xmark"></i></a>
            </div>
        </form>
    </div>
                ...
                <tbody>
                    @foreach($drivers as $driver)
                        ...
                        <tr>
                            ...
                            <td>
                                @if($driver->branch)
                                    <span class="branch-tag">{{ $driver->branch->name }}</span>
                                @else
