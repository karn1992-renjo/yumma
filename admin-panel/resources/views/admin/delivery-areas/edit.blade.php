                ...
                <form action="{{ route('admin.delivery-areas.update', $deliveryArea) }}" method="POST" id="areaForm">
                    ...
                    <div class="border rounded-3 p-3 mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="free_delivery_enabled" id="freeDeliveryEnabled" value="1" {{ old('free_delivery_enabled', $deliveryArea->free_delivery_enabled) ? 'checked' : '' }}>
                        ...
                        <div class="mt-3">
                            ...
                            <input type="number" step="0.01" min="0" name="free_delivery_threshold" class="form-control @error('free_delivery_threshold') is-invalid @enderror"
                                   value="{{ old('free_delivery_threshold', $deliveryArea->free_delivery_threshold) }}" placeholder="Example: 200">
