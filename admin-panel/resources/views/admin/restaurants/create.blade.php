...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p>Create a new restaurant and owner account</p>
        </div>
                ...
                <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="fssai_license_number" class="form-control @error('fssai_license_number') is-invalid @enderror" value="{{ old('fssai_license_number') }}" maxlength="64">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="cuisine[]" class="form-select" multiple>
                                @forelse($cuisines as $cuisine)
                                    <option value="{{ $cuisine->id }}" @if(in_array($cuisine->id, old('cuisine', []))) selected @endif>
                                        {{ $cuisine->name }}
                                    </option>
                                @empty
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" id="searchAddress" class="form-control" placeholder="Search address or landmark" value="{{ old('address') }}">
                            ...
                            <div id="mapLegend" class="map-legend mt-2">Delivery radius: <strong>{{ old('delivery_radius', 10) }} km</strong>. Drag the marker or click the map to move service area.</div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="delivery_radius" step="0.5" min="0" class="form-control @error('delivery_radius') is-invalid @enderror" value="{{ old('delivery_radius', 10) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="commission_calculation_type" class="form-select @error('commission_calculation_type') is-invalid @enderror" required>
                                <option value="global" @selected(old('commission_calculation_type', 'global') === 'global')>Use global setting</option>
                                <option value="percentage" @selected(old('commission_calculation_type') === 'percentage')>Percentage</option>
                                <option value="fixed" @selected(old('commission_calculation_type') === 'fixed')>Fixed amount</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="commission_rate" class="form-control @error('commission_rate') is-invalid @enderror" value="{{ old('commission_rate') }}" min="0" step="0.01" placeholder="Uses global setting when blank">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="delivery_time" class="form-control @error('delivery_time') is-invalid @enderror" value="{{ old('delivery_time', 30) }}" min="1" max="240">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="order_lead_time" class="form-control @error('order_lead_time') is-invalid @enderror" value="{{ old('order_lead_time', 0) }}" min="0" max="240">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="time" name="open_time" class="form-control @error('open_time') is-invalid @enderror" value="{{ old('open_time', '09:00') }}">
                            @error('open_time') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Closing Time</label>
                            <input type="time" name="close_time" class="form-control @error('close_time') is-invalid @enderror" value="{{ old('close_time', '22:00') }}">
                            @error('close_time') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Timezone</label>
                            <input type="text" name="timezone" class="form-control @error('timezone') is-invalid @enderror" value="{{ old('timezone', 'Asia/Kolkata') }}">
                            @error('timezone') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-4">
                            <div class="form-check form-switch pt-4">
                                <input class="form-check-input" type="checkbox" name="is_pure_veg" value="1" id="isPureVeg" {{ old('is_pure_veg') ? 'checked' : '' }}>
                                <label class="form-check-label fw-semibold" for="isPureVeg">Pure veg restaurant</label>
                                <div class="form-text">Prevents egg and non-veg menu items.</div>
                            </div>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="owner_phone" class="form-control @error('owner_phone') is-invalid @enderror" value="{{ old('owner_phone') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" name="owner_password" class="form-control @error('owner_password') is-invalid @enderror" required>
                            @error('owner_password') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Confirm Password <span class="text-danger">*</span></label>
                            <input type="password" name="owner_password_confirmation" class="form-control @error('owner_password_confirmation') is-invalid @enderror" required>
                        ...
                        @include('admin.partials.payout-account-fields', ['values' => [
                            ...
                            'gateway_account_id' => old('gateway_account_id', old('stripe_account_id')),
                        ]])
                    </div>
