...
<div class="page-header">
    ...
    <p>Create a promotional banner for the home page</p>
</div>
            ...
            <div class="p-4">
                <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="image" class="form-control @error('image') is-invalid @enderror" accept="image/*,.json,application/json" required>
                        <small class="text-muted">Upload a full-cover image/WebP or Lottie JSON. Recommended image size: 1200x700px. Max 8MB.</small>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="layout_mode" id="layoutMode" class="form-select @error('layout_mode') is-invalid @enderror" required>
                                <option value="text_image" @selected(old('layout_mode', 'text_image') === 'text_image')>Text + Image</option>
                                <option value="full_image" @selected(old('layout_mode') === 'full_image')>Full Image</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="small text-muted"><span id="imageRatioValue">{{ old('image_ratio', 46) }}</span>% image area in Text + Image mode</div>
                        ...
                        <div class="col-md-6 redirect-target" data-target="category">
                            ...
                            <select name="redirect_category_id" class="form-select @error('redirect_category_id') is-invalid @enderror">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" @selected((string) old('redirect_category_id') === (string) $category->id)>
                        ...
                        <div class="col-md-6 redirect-target" data-target="menu_item">
                            ...
                            <select name="redirect_menu_item_id" class="form-select @error('redirect_menu_item_id') is-invalid @enderror">
                                ...
                                @foreach($menuItems as $menuItem)
                                    <option value="{{ $menuItem->id }}" @selected((string) old('redirect_menu_item_id') === (string) $menuItem->id)>
    ...
    <div class="col-lg-4">
        <div class="table-card">
            ...
            <div class="p-4 text-center">
                <div id="imagePreview" class="mb-3 border rounded-4 p-3 bg-light" style="min-height: 240px;">
                    <i class="fas fa-image fa-3x text-muted"></i>
                    <p class="text-muted small mt-2">Banner preview will appear here</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function renderBannerPreview() {
        ...
        if (previewImage.startsWith('data:application/json')) {
